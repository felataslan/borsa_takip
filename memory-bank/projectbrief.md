...
2. **Portföy (Hesabım) Takibi:** Kullanıcıların sahip oldukları hisseleri, lot miktarı ve maliyet fiyatıyla ekleyerek toplam portföy değerini ve anlık kâr/zarar durumlarını görebilmeleri.
3. **Sektörel Gruplama:** 120'den fazla önemli BİST hissesinin "Bankacılık", "Holding", "Otomotiv", "Enerji" gibi mantıksal sektör grupları altında gösterilmesi.
4. **Endeks Takibi:** BİST 30 ve BİST 100 endekslerine ait hisselerin kendilerine ait özel sayfalarda direkt listelenebilmesi.
5. **Filtreleme & Arama:**
...
7. **Modern Arayüz:** Material UI (MUI) ve Framer Motion kullanılarak geliştirilmiş, animasyonlu, karanlık mod (dark mode) odaklı, şık ve duyarlı tasarım.
